...
class ItachiConfig(CharacterConfig):
    def __init__(self):
        ...
        self.special_attack_sound = "sound/itachi_sa.wav"
        ...
        self.special_attack2_sound = "sound/itachi_sa_2.wav"
